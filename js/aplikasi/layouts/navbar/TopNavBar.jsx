...
function TopNavBar() {
    return (
        // PERBAIKAN: Tambahkan kelas 'z-50'
        <header className="fixed w-full p-4 bg-blue-900 text-white flex justify-between items-center z-50">
            ...
            <div className="flex items-end">
                ...
                <span className="ml-3 text-lg font-semibold">PT. SUKUN WARTONO INDONESIA</span>
            </div>
